...
@section('content')
    ...
    <div class="h-full flex flex-col font-sans">
        <div class="max-w-6xl mx-auto px-4 w-full flex flex-col h-full py-4">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-3 mb-3 flex justify-between items-center border-t-4 border-t-blue-600 shrink-0">
                <div>
                    <h1 class="text-lg font-bold text-slate-900 leading-none">Posttest</h1>
                    <p class="text-slate-500 text-xs mt-1">Evaluasi akhir pembelajaran.</p>
                </div>

                {{-- WADAH FLEX UNTUK TIMER DAN PROGRESS --}}
            ...
            <form method="POST" action="{{ route('siswa.posttest.submit') }}" id="posttest-form" class="flex flex-col flex-1 min-h-0">
                @csrf

                {{-- AREA SOAL - flex-1 dan overflow-y-auto --}}
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const formPosttest = document.getElementById('posttest-form');
            let isTimeUp = false;
            ...
            const timerInterval = setInterval(function() {
                ...
                // Berubah merah saat sisa waktu <= 3 menit
            ...
            formPosttest.addEventListener('submit', (e) => {
                e.preventDefault();
